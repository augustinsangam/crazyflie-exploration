...
static inline void init_median_filter_i(struct MedianFilterInt *filter,
                                        uint8_t size) {
  uint8_t i;
...
static inline int32_t update_median_filter_i(struct MedianFilterInt *filter,
                                             int32_t new_data) {
...
static inline void init_median_filter_f(struct MedianFilterFloat *filter,
                                        uint8_t size) {
  uint8_t i;
...
static inline float update_median_filter_f(struct MedianFilterFloat *filter,
                                           float new_data) {
  float temp;
...
static inline uint8_t movingAvg(int *ptrArrNumbers, long *ptrSum, int pos,
                                int len, int nextNum) {
